# <copyright file="ZeroFailed.Deploy.PowerBI.psm1" company="Endjin Limited">
# Copyright (c) Endjin Limited. All rights reserved.
# </copyright>

Set-Alias ZeroFailed.Deploy.PowerBI.tasks $PSScriptRoot/import-tasks.ps1
...
Export-ModuleMember -Function ( $functions | 
                    ...
                    -Alias ZeroFailed.Deploy.PowerBI.tasks
